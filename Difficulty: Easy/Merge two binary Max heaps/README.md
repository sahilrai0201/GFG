...
<input style="height: 160px; width: 300px;" alt="" src="https://media.geeksforgeeks.org/wp-content/uploads/Merge_max_heap_1.jpg" type="image">
<input style="height: 120px; width: 200px;" alt="" src="https://media.geeksforgeeks.org/wp-content/uploads/Merge_max_heap_2.jpg" type="image">
<span style="font-size: 18px;"><input style="height: 160px; width: 300px;" alt="" src="https://media.geeksforgeeks.org/wp-content/uploads/Merge_max_heap_3.jpg" type="image"></span></pre>
<p>&nbsp;</p>
<p>&nbsp;</p>
